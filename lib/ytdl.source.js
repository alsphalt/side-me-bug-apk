  ...
  try {
    ...
    try {
      for await (const chunk of response.data) {
        ...
        if (!writer.write(chunk)) await new Promise((resolve, reject) => { writer.once('drain', resolve); writer.once('error', reject) })
      }
...
module.exports = { ytdlv1, ytdlv2, ytdlv3, ytdlv4, ytdlAuto, ytdlAutoBuffer, ytdlDirectBuffer, ytdlClassicBuffer, extractYouTubeId, getYouTubeMetadata, ytdlAutoVideoFile }
